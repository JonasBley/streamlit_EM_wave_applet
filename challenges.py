...
CHALLENGES = {
    "Master Tutorial: The Polarization Journey": {
        "steps": [
            ...
            {
                "text": r"Done. Congratulations, you completed the tutorial. The codeword to proceed in the study is <b>vertical light</b>. Feel free to play around with the applet!<br>",
                "task": r"",
