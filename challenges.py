...
CHALLENGES = {
    "Polarization 1": {
        "steps": [
            {
                "text": r"<b>Step 1: The Macroscopic Wave</b><br>Classical light is an electromagnetic wave where the electric field $\vec{E}$ is confined to the transverse $x$-$y$ plane, oscillating perpendicular to the direction of propagation. The wave can be described by the so-called Jones vector $\vec{E} = \begin{pmatrix} E_x \\ E_y e^{i\varphi} \end{pmatrix}$. This vector describes the electromagnetic wave with its maximum amplitudes in $x$ and $y$-direction, $E_x$ and $E_y$, and a relative phase between the components of the electromagnetic wave. The absolute value of the amplitudes of the Jones vector squared must add up to one: $|E_X|^2+|E_Y|^2=1$.",
                "task": r"Move the slider to $E_x=0.5$ and watch the change in the electric field components and the combined wave in the applet below. Move it around for a closer look. Notice how the amplitude in $y$ direction $E_y$ is not the same as $E_x$.",
            ...
            },
            {
                ...
                "hint": r"You want the amplitudes to be perfectly balanced. Mathematically, start with $|E_x|^2+|E_y|^2=1$, and require that $|E_x|=|E_y|$.",
            ...
            },
            {
                ...
                "hint": r"Look at the orange dashed rotation axis on the sphere. You need to rotate the green state vector around this axis by 270 degrees ($1.5\pi$) to reach the bottom pole.",
            ...
            {
                "text": r"<b>Step 8: Putting it all together</b><br>Let's combine operators!",
                ...
                "target": {"E_x_amp": 0.71, "E_y_amp": 0.0},
            ...
            {
                "text": r"<b>Step 9: The Final Challenge</b><br>Let's combine operators for a lossless transmission!",
                ...
                "setup": {"insert_wp": True, "insert_pol": True, "E_x_amp": 0.707, "phase_relative_pi": 0.5, "wp_angle_deg": 45.0, "retardance_pi": 0.0, "pol_angle_deg": 0.0, "show_toggles": False, "disable_keys": ["E_x_amp", "phase_relative_pi"]},
            ...
            {
                "text": r"Done. Congratulations, you completed the tutorial. Feel free to play around with the applet! The code to proceed in the study is <b>horizontal light</b>. Please copy this, go back to the survey, and enter to proceed.<br>",
                "task": r"",
    ...
    "Polarization 2": {
        "steps": [
            ...
            {
                "text": r"<b>Step 3: Circular States</b><br>Notice how the diagonal state you just created features perfectly balanced amplitudes and no phase shift $\varphi=0$.",
                "task": r"Now, introduce a relative phase shift to create a <b>Right-Circular</b> state. Watch the behavior of the electric field components along the propagation axis:<br>$\mathbf{J}_{R} = \frac{1}{\sqrt{2}} \begin{pmatrix} 1 \\ e^{i\pi/2} \end{pmatrix} = \frac{1}{\sqrt{2}} \begin{pmatrix} 1 \\ i \end{pmatrix}$",
                "hint": r"Circular states require equal amplitudes (which you already have) but a $\pi/2$ phase shift.",
            ...
            {
                "text": r"Done. Congratulations, you completed the tutorial. Feel free to play around with the applet! The code to proceed in the study is <b>vertical light</b>. Please copy this, go back to the survey, and enter to proceed.<br>",
                "task": r"",
