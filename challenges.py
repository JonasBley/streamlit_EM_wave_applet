        ...
        "steps": [
            {
                ...
                "task": r"Move the slider to $E_x=0.5$ and notice how the amplitude in $y$ direction $E_y$ is not the same.",
            ...
            {
                "text": r"<b>Step 2: Constructing Standard States</b><br>Any state of polarization can be expressed as a linear combination of horizontal $\mathbf{J}_H=\begin{pmatrix}1 \\ 0\end{pmatrix}$ and vertical $\mathbf{J}_V=\begin{pmatrix}0 \\ 1\end{pmatrix}$ basis vectors.",
            ...
            },
            {
                ...
                "hint": r"Circular states require equal amplitudes (which you already have) but a $90^\circ$ phase shift. Set the <b>Relative Phase $\varphi$</b> slider to exactly <b>0.5</b>.",
            ...
            },
            {
                ...
                "task": r"Starting with a Horizontal incident wave ($E_x = 1.0$), find the <i>Retardance</i> $\Gamma$ necessary to output a <b>Vertical</b> state.",
                "hint": r"To rotate a horizontal vector to a vertical one, you must completely invert the axis. This requires a half-wave plate that has a retardance of $\Gamma=\pi$.",
            ...
            },
            {
                ...
                "hint": r"To travel along the equator (Horizontal) to the Diagonal state, your rotation axis on the sphere needs to reflect, i.e. a $180^\circ$ rotation around an axis that is exactly $45^\circ$ away from Horizontal. Since the physical angle is half the sphere angle, set your Fast Axis to <b>$22.5^\circ$</b> and the retardance to 1.0.",
            ...
            },
            {
                ...
                "hint": r"You want the final state to sit on the pure Horizontal axis of the sphere. Turn your Polarizer's Transmission Axis to exactly <b>$0^\circ$</b> (or $180^\circ$). Notice how the intensity drops to exactly 50% as you project the Diagonal vector.",
            ...
            },
            {
                ...
                "task": r"Set your incident wave to <b>Vertical</b> ($E_x=0.0$). Your goal is to pass this light through BOTH a wave plate and a polarizer to achieve a final transmitted state that is <b>Horizontal</b> with an intensity of exactly <b>50%</b> of the original beam. <br><br><i>(Hint: First use a Quarter-Wave plate to transform the Vertical light into a Right-Circular state, then project it using the polarizer.)</i>",
                "hint": r"Step 1: Set Retardance to <b>$0.5\pi$</b> and Fast Axis to <b>$45^\circ$</b> to lift the Vertical state to the North Pole.<br>Step 2: Set the Polarizer Transmission Axis to <b>$0^\circ$</b> (Horizontal) to project 50% of the circular light down onto the horizontal axis.",
